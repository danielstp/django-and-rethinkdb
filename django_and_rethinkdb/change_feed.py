...
def print_changes():
    conn = yield r.connect(settings.RETHINKDB['host'], port=settings.RETHINKDB['port'])
...
class MessageHandler(tornado.web.RequestHandler):
    ...
    @tornado.gen.coroutine
    def get(self):
        conn = yield r.connect(settings.RETHINKDB['host'], port=settings.RETHINKDB['port'], db='rethinkdb_chat')
